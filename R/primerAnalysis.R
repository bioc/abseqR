...
.primerAnalysis <-
    function(primerDirectories,
        ...
        analysisType <-
            c("stopcodon", "integrity", "indelled", "indel_pos")
        ...
        for (ctg in category) {
            for (i in seq_along(allPrimers)) {
                ...
                if (!is.null(primerNames)) {
                    ...
                    message(
                        paste(
                            "Primers found across all samples",
                            combinedNames
                            ,
                            "for",
                            paste0(pend, "'"),
                    ...
                    for (j in seq_along(analysisType)) {
                        ...
                        if (length(files)) {
                            ...
                            primPlot <- .plotDist(
                                ...
                                paste(
                                    paste0(
                                        .canonicalizeTitle(analysisType[j]),
                                        " ",
                                        pend,
                                        "'-end Primer Sequence (",
                                        .canonicalizeTitle(ctg),
